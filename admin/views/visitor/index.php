      ...
      <table class="table">
        ...
        <tbody>
          <?php foreach ($servicios as $servicio): ?>
            <tr>
              <th scope="row"><?php echo ($servicio['servicio']) ?></th>
              <td><?php echo ($servicio['descripcion']) ?></td>
              <td>
                <p>Uber/Taxi $<?php echo ($servicio['p_ubertaxi']) ?></p>
                <p>Carro $<?php echo ($servicio['p_carro']) ?></p>
                <p>Camioneta $<?php echo ($servicio['p_camioneta']) ?></p>
                <p>Van $<?php echo ($servicio['p_van']) ?></p>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
